...
import {
  MULTICALL_ADDRESSES as APP_MULTICALL_ADDRESSES,
  NONFUNGIBLE_POSITION_MANAGER_ADDRESSES as APP_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES,
  V3_MIGRATOR_ADDRESSES_OVERRIDE,
...
const MULTICALL_ADDRESSES = { ...SDK_MULTICALL_ADDRESSES, ...APP_MULTICALL_ADDRESSES }
const NONFUNGIBLE_POSITION_MANAGER_ADDRESSES = {
  ...SDK_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES,
  ...APP_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES,
}

const V3_MIGRATOR_ADDRESSES = { ...SDK_V3_MIGRATOR_ADDRESSES, ...V3_MIGRATOR_ADDRESSES_OVERRIDE }
