...
import { TT_CHAIN_MAINNET_ID, TT_CHAIN_TESTNET_ID } from '../constants/chains'
...
const BLOCK_EXPLORER_PREFIXES: { [chainId: number]: string } = {
  ...
  [TT_CHAIN_MAINNET_ID]: 'https://ttchainscan.com',
  [TT_CHAIN_TESTNET_ID]: 'https://testnet.ttchainscan.com',
}
