...
function getClassicTradeDetails(
  ...
  return {
    ...
    gasUseEstimateQuoteRaw:
      classicQuote?.gasUseEstimateQuote !== undefined &&
      classicQuote.gasUseEstimateQuote !== '' &&
      classicQuote.gasUseEstimateQuote !== 'null'
        ? classicQuote.gasUseEstimateQuote
        : undefined,
...
export async function transformRoutesToTrade(
  ...
  const { gasUseEstimateUSD, blockNumber, routes, gasUseEstimate, gasUseEstimateQuoteRaw } = getClassicTradeDetails(
    currencyIn,
    currencyOut,
    data
  )
