...
const IFRAME_PARAM = 'isIframe'

export default function App() {
  const location = useLocation()
  const { pathname, search } = location
  const isIframe = useMemo(() => new URLSearchParams(search).get(IFRAME_PARAM) === 'true', [search])
  ...
  if (shouldBlockPath && pathname !== '/swap') {
    return <Navigate to={toWithPreservedRouterSearch('/swap', search)} replace />
  }
