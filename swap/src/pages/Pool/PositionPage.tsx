...
import { formatFeeCurrencyAmount } from 'utils/formatCurrencyAmount'
...
const TokenLink = ({
  ...
  return (
    <StyledRouterLink to={toWithPreservedRouterSearch(`/tokens/${chainName}/${address}`, routerSearch)}>
      {children}
    </StyledRouterLink>
  )
}
...
function LinkedCurrency({
  ...
  if (typeof chainId === 'number' && address) {
    if (isGqlSupportedChain(chainId)) {
      return (
        <TokenLink chainId={chainId} address={address} routerSearch={routerSearch}>
          <RowFixed>
    ...
    return (
      <ExternalTokenLink chainId={chainId} address={address}>
        <RowFixed>
          <CurrencyLogo currency={currency} size="20px" style={{ marginRight: '0.5rem' }} />
          <ThemedText.DeprecatedMain>{currency?.symbol} ↗</ThemedText.DeprecatedMain>
        </RowFixed>
  ...
  return (
    <PageWrapper>
      <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
        ...
        <PositionPageButtonPrimary as={Link} to={toWithPreservedRouterSearch('/pools', search)} width="fit-content">
          ...
          <AutoColumn gap="md">
            <RowBetween>
              <RowFixed>
                ...
                <ThemedText.DeprecatedMain>
                  {feeValueUpper ? formatFeeCurrencyAmount(feeValueUpper) : '-'}
                </ThemedText.DeprecatedMain>
              </RowFixed>
            ...
            <RowBetween>
              <RowFixed>
                ...
                <ThemedText.DeprecatedMain>
                  {feeValueLower ? formatFeeCurrencyAmount(feeValueLower) : '-'}
                </ThemedText.DeprecatedMain>
              </RowFixed>
        ...
        <AutoColumn gap="md">
          <AutoColumn gap="sm">
            <Link
              ...
              to={toWithPreservedRouterSearch('/pools', search)}
            >
              <HoverText>
                <Trans>← Back to Pools</Trans>
              </HoverText>
              ...
              {ownsNFT && (
                <ActionButtonResponsiveRow>
                  {currency0 && currency1 && feeAmount && tokenId ? (
                    <ButtonGray
                      as={Link}
                      to={toWithPreservedRouterSearch(
                  ...
                  {tokenId && !removed ? (
                    <SmallButtonPrimary
                      as={Link}
                      to={toWithPreservedRouterSearch(`/remove/${tokenId}`, search)}
                      padding="6px 8px"
                      width="fit-content"
                      $borderRadius="12px"
                    >
              ...
              <DarkCard>
                <AutoColumn gap="md" style={{ width: '100%' }}>
                  ...
                  <LightCard padding="12px 16px">
                    <AutoColumn gap="md">
                      <RowBetween>
                        <LinkedCurrency chainId={chainId} currency={currencyQuote} routerSearch={search} />
                        <RowFixed>
                          <ThemedText.DeprecatedMain>
                      ...
                      <RowBetween>
                        <LinkedCurrency chainId={chainId} currency={currencyBase} routerSearch={search} />
                        <RowFixed>
                          <ThemedText.DeprecatedMain>
