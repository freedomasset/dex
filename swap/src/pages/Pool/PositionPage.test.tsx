...
describe('position page', () => {
  it('correctly collects the correct amount', () => {
    ...
    expect(screen.getByText(formatFeeCurrencyAmount(USDC_AMOUNT))).toBeInTheDocument()
    expect(screen.getByText(formatFeeCurrencyAmount(WETH_AMOUNT))).toBeInTheDocument()
