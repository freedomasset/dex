...
export default function Landing() {
  ...
  useEffect(() => {
    if (accountDrawerOpen) {
      setTimeout(() => {
        navigate(toWithPreservedRouterSearch('/swap', location.search))
      }, TRANSITION_DURATIONS.fast)
    }
  }, [accountDrawerOpen, navigate, location.search])
  ...
  return (
    <PageContainer data-testid="landing-page">
      <LandingSwapContainer>
        <Link to={toWithPreservedRouterSearch('/swap', location.search)}>
          <LandingSwap />
        </Link>
      </LandingSwapContainer>
      ...
      <ContentContainer isDarkMode={isDarkMode}>
        ...
        <ActionsContainer>
          <ButtonCTA as={Link} to={toWithPreservedRouterSearch('/swap', location.search)}>
            <ButtonCTAText>
