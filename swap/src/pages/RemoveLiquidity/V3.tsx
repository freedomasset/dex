        ...
        return provider
          ...
          .then((response: TransactionResponse) => {
            ...
            addTransaction(response, {
              ...
              baseCurrencySymbol: liquidityValue0.currency.symbol ?? undefined,
              baseCurrencyDecimals: liquidityValue0.currency.decimals,
              quoteCurrencySymbol: liquidityValue1.currency.symbol ?? undefined,
              quoteCurrencyDecimals: liquidityValue1.currency.decimals,
            })
          })
      })
      .catch((error) => {
