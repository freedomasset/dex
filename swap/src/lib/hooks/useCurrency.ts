...
import { DEFAULT_ERC20_DECIMALS, NATIVE_CHAIN_ID, TOKEN_SHORTHANDS } from '../../constants/tokens'
...
export function useCurrencyFromMap(
  ...
  const isNative = Boolean(
    nativeCurrency &&
      (currencyId === NATIVE_CHAIN_ID || currencyId?.toUpperCase() === nativeCurrency.symbol?.toUpperCase())
  )
