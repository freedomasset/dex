...
export const ButtonPrimary = styled(BaseButton)`
  ...
  color: ${() => '#000000'};
  // &:focus {
  //   box-shadow: 0 0 0 1pt ${() => darken(0.05, '#393939')};
  //   background-color: ${() => darken(0.05, '#393939')};
  // }
  &:hover {
    background-color: ${() => '#33d3eb'};
  }
  // &:active {
  //   box-shadow: 0 0 0 1pt ${() => darken(0.1, '#393939')};
  //   background-color: ${() => darken(0.1, '#393939')};
  // }
  &:disabled {
    opacity: 1;
    background-color: ${({ altDisabledStyle, disabled }) =>
      altDisabledStyle ? (disabled ? '#393939' : '#393939') : '#393939'};
    color: ${() => '#010101'};
    cursor: auto;
    box-shadow: none;
    border: 1px solid transparent;
...
const BaseButtonLight = styled(BaseButton)`
  ...
  &:focus {
    box-shadow: 0 0 0 1pt ${({ disabled }) => !disabled && '#33D3EB'};
    background-color: ${({ disabled }) => !disabled && '#33D3EB'};
  }
  &:hover {
    background-color: ${({ disabled }) => !disabled && '#33D3EB'};
  }
