...
import { getTranslatedActivityTitle } from 'components/AccountDrawer/MiniPortfolio/activityTitleTranslations'
...
function ActivityPopupContent({ activity, onClick, onClose }: ActivityPopupContentProps) {
  ...
  const title = getTranslatedActivityTitle(activity.title, i18n.locale)
