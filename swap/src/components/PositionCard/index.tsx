          ...
          <AutoColumn gap="sm">
            ...
            {userDefaultPoolBalance && JSBI.greaterThan(userDefaultPoolBalance.quotient, BIG_INT_ZERO) && (
              <RowBetween marginTop="10px">
                <ButtonPrimary
                  ...
                  $borderRadius="8px"
                  as={Link}
                  to={toWithPreservedRouterSearch(`/migrate/v2/${pair.liquidityToken.address}`, search)}
                  width="32%"
                >
                  <Trans>Migrate</Trans>
                </ButtonPrimary>
                <ButtonPrimary
                  ...
                  $borderRadius="8px"
                  as={Link}
                  to={toWithPreservedRouterSearch(`/add/v2/${currencyId(currency0)}/${currencyId(currency1)}`, search)}
                  width="32%"
                >
                  <Trans>Add</Trans>
                </ButtonPrimary>
                <ButtonPrimary
                  ...
                  to={toWithPreservedRouterSearch(
                    `/remove/v2/${currencyId(currency0)}/${currencyId(currency1)}`,
                    search
                  )}
                >
                  <Trans>Remove</Trans>
            ...
            {stakedBalance && JSBI.greaterThan(stakedBalance.quotient, BIG_INT_ZERO) && (
              <ButtonPrimary
                ...
                $borderRadius="8px"
                as={Link}
                to={toWithPreservedRouterSearch(`/uni/${currencyId(currency0)}/${currencyId(currency1)}`, search)}
                width="100%"
              >
