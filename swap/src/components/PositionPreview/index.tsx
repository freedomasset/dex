...
import { type CurrencyAmount, Currency } from '@vanadex/sdk-core'
...
export const PositionPreview = ({
  ...
  depositAmount0?: CurrencyAmount<Currency>
  depositAmount1?: CurrencyAmount<Currency>
  ...
  const badgePosition = statusPosition ?? position
  const removed = badgePosition?.liquidity && JSBI.equal(badgePosition.liquidity, JSBI.BigInt(0))

  const displayAmount0 = depositAmount0 ?? position.amount0
  const displayAmount1 = depositAmount1 ?? position.amount1
      ...
      <LightCard>
        <AutoColumn gap="md">
          <RowBetween>
            ...
            <RowFixed>
              <ThemedText.DeprecatedLabel mr="8px">{displayAmount0.toSignificant(4)}</ThemedText.DeprecatedLabel>
            </RowFixed>
          </RowBetween>
          <RowBetween>
            <RowFixed>
            ...
            <RowFixed>
              <ThemedText.DeprecatedLabel mr="8px">{displayAmount1.toSignificant(4)}</ThemedText.DeprecatedLabel>
            </RowFixed>
          </RowBetween>
          <Break />
          <RowBetween>
