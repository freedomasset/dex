  ...
  switch (errorType) {
    case PendingModalError.TOKEN_APPROVAL_ERROR:
      return {
        ...
        tooltipText: (
          <Trans>
            This authorizes the app to use your tokens for trading. For security, this will expire after 30 days.
          </Trans>
        ),
      }
...
export function ErrorModalContent({ errorType, onRetry, detailMessage }: ErrorModalContentProps) {
  ...
  return (
    <PendingModalContainer gap="lg">
      ...
      <ColumnCenter gap="md">
        ...
        {detailMessage && (
          <ThemedText.BodySmall color="neutral2" textAlign="center">
            {detailMessage}
