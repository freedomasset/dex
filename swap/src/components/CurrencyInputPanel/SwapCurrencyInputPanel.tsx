...
import SelectIcon from '../../assets/images/simpleFlow/selectIcon.png'
...
const CurrencySelect = styled(ButtonGray)<{
  ...
  &:hover,
  &:active {
    background-color: ${({ theme, selected }) => (selected ? theme.surface2 : theme.surface2)};
  }
    ...
    return (
      <InputPanel hideInput={hideInput} {...rest}>
        ...
        <Container hideInput={hideInput}>
          <ThemedText.SubHeaderSmall style={{ userSelect: 'none', marginBottom: '11px' }}>
            {label}
            ...
            >
              ...
              >
                <Aligner>
                  <RowFixed>
                    {pair ? (
                      <span style={{ marginRight: '12px' }}>
                        <DoubleCurrencyLogo currency0={pair.token0} currency1={pair.token1} size={46} margin={true} />
                      </span>
                    ) : currency ? (
                      <CurrencyLogo style={{ marginRight: '12px' }} currency={currency} size="46px" />
                    ) : null}
                    {pair ? (
                      <StyledTokenName className="pair-name-container">
                        ...
                        >
                          {payType === 'From' ? <Trans>From</Trans> : <Trans>To</Trans>}
                        </div>
                  ...
                  {onCurrencySelect && <img src={SelectIcon} alt="select" style={{ width: '40px', height: '40px' }} />}
                </Aligner>
              </CurrencySelect>
            </Tooltip>
          </>
          <div style={{ position: 'relative', marginTop: '30px', marginBottom: '20px' }}>
            <InputRow style={hideInput ? { padding: '0', borderRadius: '8px' } : {}}>
              {!hideInput && (
                <div
                  style={{ display: 'flex', width: 'calc(100% - 80px)' }}
