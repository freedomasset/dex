...
import {
  ARB,
  ATT_TT_CHAIN_MAINNET,
  ATT_TT_CHAIN_TESTNET,
  BTC_BSC,
  BUSD_BSC,
  CEUR_CELO,
  CEUR_CELO_ALFAJORES,
  ...
  DAI_POLYGON,
  ETH_BSC,
  MYUSDC_TT_CHAIN_MAINNET,
  MyUSDC_TT_CHAIN_TESTNET,
  nativeOnChain,
  OP,
  PORTAL_ETH_CELO,
  PORTAL_USDC_CELO,
  RWA001_TT_CHAIN_MAINNET,
  RWA001_TT_CHAIN_TESTNET,
  TEST_TT_CHAIN_MAINNET,
  Test_TT_CHAIN_TESTNET,
  TIMER_TT_CHAIN_MAINNET,
  Timer_TT_CHAIN_TESTNET,
  TTUSD_TT_CHAIN_MAINNET,
  TTUSD_TT_CHAIN_TESTNET,
  USDC_ARBITRUM,
  ...
  USDT_POLYGON,
  USDT_SEPOLIA,
  USDT_TT_CHAIN_MAINNET,
  USDT_TT_CHAIN_TESTNET,
  WBTC,
  WBTC_ARBITRUM_ONE,
  WBTC_CELO,
  WBTC_OPTIMISM,
  WBTC_POLYGON,
  WBTC_TT_CHAIN_MAINNET,
  WBTC_TT_CHAIN_TESTNET,
  WETH_AVALANCHE,
  WETH_POLYGON,
  WETH_POLYGON_MUMBAI,
  WETH_TT_CHAIN_MAINNET,
  WETH_TT_CHAIN_TESTNET,
...
export const COMMON_BASES: ChainCurrencyList = {
  ...
  [TT_CHAIN_MAINNET_ID]: [
    nativeOnChain(TT_CHAIN_MAINNET_ID),
    WRAPPED_NATIVE_CURRENCY[TT_CHAIN_MAINNET_ID] as Token,
    USDC_TT_CHAIN_MAINNET,
    ATT_TT_CHAIN_MAINNET,
    WETH_TT_CHAIN_MAINNET,
    USDT_TT_CHAIN_MAINNET,
  ...
  [TT_CHAIN_TESTNET_ID]: [
    nativeOnChain(TT_CHAIN_TESTNET_ID),
    WRAPPED_NATIVE_CURRENCY[TT_CHAIN_TESTNET_ID] as Token,
    USDC_TT_CHAIN_TESTNET,
    ATT_TT_CHAIN_TESTNET,
    WETH_TT_CHAIN_TESTNET,
    USDT_TT_CHAIN_TESTNET,
