...
export const TTCHAIN_MAINNET_LIST = '/ttchain-mainnet-tokenList.json'
export const TT_CHAIN_TESTNET_LIST = '/ttchain-testnet-tokenList.json'
...
export const DEFAULT_INACTIVE_LIST_URLS: string[] = [
  ...
  // BASE_LIST,
  VANA_MOKSHA_LIST,
  TTCHAIN_MAINNET_LIST,
  TT_CHAIN_TESTNET_LIST,
]
