...
export const ButtonPrimary = styled(Base)<{ bgColor?: string; altDisabledStyle?: boolean, bgHoverColor?: string }>`
  background-color: ${({ theme, bgColor }) => bgColor ?? theme.primary1};
  color: ${({ bgColor }) => bgColor === '#FFFFFF' ? '#000000' : 'white'};
  &:focus {
  ...
  &:hover {
    box-shadow: 0 0 0 1pt ${({ theme, bgColor, bgHoverColor }) => bgHoverColor ? bgHoverColor : darken(0.1, bgColor ?? theme.primary1)};
    border-color: ${({ theme, bgColor, bgHoverColor }) => bgHoverColor ? bgHoverColor : darken(0.05, bgColor ?? theme.primary1)};
    background-color: ${({ theme, bgColor, bgHoverColor }) => bgHoverColor ? bgHoverColor : darken(0.05, bgColor ?? theme.primary1)};
  }
  &:active {
