...
import ChainQuerySync from '../components/ChainQuerySync'
...
const BodyWrapper = styled.div<{ $warningActive?: boolean }>`
  ...
  width: 100%;
  padding-top: 0px;
  margin-top: ${({ $warningActive }) => ($warningActive ? '110px' : '70px')};
  align-items: center;
  flex: 1;
  overflow-y: auto;
  overflow-x: hidden;
...
export default function App() {
  ...
  // 默认网络仍由 getNetworkByEnv（reducer）；?chain= 由 ChainQuerySync 覆盖并回写
