...
import { ChainId, Currency, CurrencyAmount, Fraction, Percent, Token } from '@vanadex/sdk-core'
import { TT_CHAIN_MAINNET_CHAIN_ID, TT_CHAIN_TESTNET_CHAIN_ID } from 'constants/chains'

import JSBI from 'jsbi'
import { getNetworkByEnv } from './getNetworkByEnv'
...
const BLOCK_EXPLORER_PREFIXES: { [chainId: number]: string } = {
  ...
  [TT_CHAIN_TESTNET_CHAIN_ID]: 'https://testnet.ttchainscan.com',
  [TT_CHAIN_MAINNET_CHAIN_ID]: 'https://ttchainscan.com',
}
...
export function getExplorerLink(chainId: number, data: string, type: ExplorerDataType): string {
  const prefix =
    ...
    BLOCK_EXPLORER_PREFIXES[getNetworkByEnv().chainId] ??
    'https://ttchainscan.com'
