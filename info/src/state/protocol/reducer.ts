...
export const initialState: ProtocolState = {
  ...
  [SupportedNetwork.VANA]: DEFAULT_INITIAL_STATE,
  [SupportedNetwork.VANA_MOKSHA]: DEFAULT_INITIAL_STATE,
  [SupportedNetwork.TT_CHAIN]: DEFAULT_INITIAL_STATE,
  [SupportedNetwork.TT_CHAIN_MAINNET]: DEFAULT_INITIAL_STATE,
  [SupportedNetwork.SEPOLIA]: DEFAULT_INITIAL_STATE,
}
