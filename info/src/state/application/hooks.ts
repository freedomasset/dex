...
import {
  ...
  ttChainBlockClient,
  ttChainClient,
  ttChainMainnetBlockClient,
  ttChainMainnetClient,
  vanaBlockClient,
  vanaClient,
  vanaMokshaBlockClient,
  vanaMokshaClient,
} from 'apollo/client'
...
export function useDataClient(): ApolloClient<NormalizedCacheObject> {
  ...
  switch (activeNetwork.id) {
    ...
    case SupportedNetwork.VANA:
      return vanaClient
    case SupportedNetwork.VANA_MOKSHA:
      return vanaMokshaClient

    case SupportedNetwork.TT_CHAIN:
      return ttChainClient
    case SupportedNetwork.TT_CHAIN_MAINNET:
      return ttChainMainnetClient
    default:
      return ttChainMainnetClient
  }
}
...
export function useBlockClient(): ApolloClient<NormalizedCacheObject> {
  ...
  switch (activeNetwork.id) {
    ...
    case SupportedNetwork.SEPOLIA:
      return sepoliaBlockClient

    case SupportedNetwork.VANA:
      return vanaBlockClient
    case SupportedNetwork.VANA_MOKSHA:
      return vanaMokshaBlockClient

    case SupportedNetwork.TT_CHAIN:
      return ttChainBlockClient
    case SupportedNetwork.TT_CHAIN_MAINNET:
      return ttChainMainnetBlockClient
    default:
      return ttChainMainnetBlockClient
  }
}
